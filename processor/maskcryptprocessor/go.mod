module github.com/ngoldack/maskcrypt/processor/maskcryptprocessor

go 1.24.1

require go.opentelemetry.io/collector/component v1.28.1

require (
	github.com/ngoldack/maskcrypt v0.0.0-00010101000000-000000000000
...
require (
	...
	go.opentelemetry.io/collector/cmd/mdatagen v0.122.1 // indirect
...
require (
	...
	go.opentelemetry.io/collector/processor/processorhelper v0.0.0-20250328163324-c56d8f6beeab
...
replace github.com/ngoldack/maskcrypt => ../..
